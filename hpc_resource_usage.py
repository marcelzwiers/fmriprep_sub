...
if __name__ == '__main__':
    ...
    parser.add_argument('datafolders', help='Space separated list of folders containing pbs-logfiles (try "demo" for using fmriprep demo data). It is assumed that the logfiles contain a line similar to "Used resources:	   cput=03:22:23,walltime=01:01:53,mem=17452716032b"', nargs='*', default='.')
