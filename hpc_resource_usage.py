...
if __name__ == '__main__':
    ...
    if args.datafolders == ['demo']:
        ...
        datasets = [Path(datafolder)/'*.[oO][0-9U]*' if ('?' not in datafolder and '*' not in datafolder and '[' not in datafolder) else Path(datafolder) for datafolder in args.datafolders]
